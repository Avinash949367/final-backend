...
router.get('/admin', ensureAuthenticated, ensureAdmin, getAllUsers);
router.get('/admin/:id', ensureAuthenticated, ensureAdmin, getUserById);
router.put('/admin/:id', ensureAuthenticated, ensureAdmin, updateUser);
router.delete('/admin/:id', ensureAuthenticated, ensureAdmin, deleteUser);
router.post('/admin/:id/ban', ensureAuthenticated, ensureAdmin, banUser);
router.post('/admin/:id/disable', ensureAuthenticated, ensureAdmin, disableUser);
